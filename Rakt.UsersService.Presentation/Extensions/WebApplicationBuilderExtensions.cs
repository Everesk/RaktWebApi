...
/// <summary>Расширения для стандартной настройки построителя API пользователей.</summary>
public static class WebApplicationBuilderExtensions
{
    /// <summary>Регистрирует сбор и экспорт трейсов и метрик сервиса пользователей.</summary>
